...
namespace WebCamCapture {
    ...
    public partial class orderDataSet1 : global::System.Data.DataSet {
        ...
        public partial class operationDataTable : global::System.Data.TypedTableBase<operationRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public operationRow AddoperationRow(string operation) {
            ...
            public string operation {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'operation\' в таблице \'operation\' равно DBNull.", e);
                    }
                }
                set {
...
namespace WebCamCapture.orderDataSet1TableAdapters {
    ...
    public partial class operationTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `operation` WHERE ((`id` = ?) AND ((? = 1 AND `operation` IS NULL) OR" +
                " (`operation` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `operation` (`operation`) VALUES (?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `operation` SET `operation` = ? WHERE ((`id` = ?) AND ((? = 1 AND `operati" +
                "on` IS NULL) OR (`operation` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, operation FROM operation";
        ...
        public virtual int Fill(orderDataSet1.operationDataTable dataTable) {
        ...
        public virtual orderDataSet1.operationDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            orderDataSet1.operationDataTable dataTable = new orderDataSet1.operationDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(orderDataSet1.operationDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_operation) {
        ...
        public virtual int Insert(string operation) {
            if ((operation == null)) {
        ...
        public virtual int Update(string operation, int Original_id, string Original_operation) {
            if ((operation == null)) {
            ...
            if ((Original_operation == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[3].Value = ((string)(Original_operation));
            }
